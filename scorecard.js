    ...
    for(let i = 0; i < bothInningsArr.length; i++) {
        ...
        for(let j = 0; j<allRows.length; j++){
            ...
            if(numberOfTds.length==8){
                ...
                console.log(`${teamName}|${playerName}|${runs}|${balls}|${fours}|${sixes}|${sr}|${result}`);
                //|${venue}|${date}
                processPlayer(teamName,playerName,runs,balls,fours,sixes,sr,result);
                //,venue,date
            }
        }
...
function processPlayer(teamName,playerName,runs,balls,fours,sixes,sr,result){
    //,venue,date
